          ...
          <div className="flex items-center space-x-3">
            ...
            <div
              className={`flex items-center space-x-1.5 text-sm ${
                isDark ? 'text-slate-400' : 'text-sky-900 font-medium'
              }`}
            >
              <LayoutGrid className={`w-4 h-4 ${isDark ? 'text-slate-500' : 'text-sky-700'}`} />
              <span>事務所資料</span>
              <span className={isDark ? 'text-slate-700' : 'text-sky-400'}>/</span>
            ...
            <button
              ...
              className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-lg border text-xs font-medium transition-all duration-300 ${
                isDark
                  ...
                  : 'bg-sky-200/80 border-sky-300 text-blue-950 hover:bg-sky-300/80'
              }`}
            ...
            <kbd
              className={`text-xs px-2.5 py-1 rounded border font-mono font-bold transition-colors duration-300 ${
                isDark
                  ...
                  : 'text-blue-950 bg-sky-200 border-sky-300'
              }`}
            >
              Esc 返回
            </kbd>
